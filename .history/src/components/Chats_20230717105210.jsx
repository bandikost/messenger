...
const Chats = () => {
  ...
  const [handleMenuClick] = useState({ top: 10, left: 10 });
      ...
      {isMenuOpen && (
        ...
        >
          <ul className="menuContent">
            <li onClick={handleMenuClick}  style={{
            position: 'fixed',
            top: handleMenuClick.top,
            left: handleMenuClick.left,
          }}>Удалить диалог</li>
            <li onClick={handleMenuClick}>Option 2</li>
            <li onClick={handleMenuClick}>Option 3</li>
          </ul>
        </div>
      )}
      <div onContextMenu={handleContextMenu} onClick={handleOutsideClick}>
