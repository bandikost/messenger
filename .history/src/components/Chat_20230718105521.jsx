    ...
    <div className="chat" >
      <div className="chatInfo">  
        <span className={showImage ? 'show' : ''} onClick={handleImageClick}>
          <img className={showImage ? 'show-img' : ''} onClick={handleButtonClick} src={data.user?.photoURL} alt="" width={"50px"} height={"50px"} style={{borderRadius: showImage > 0 ? "0%" : '50%', objectFit: "fill" }}  />
