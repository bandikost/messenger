...
export const Chat = () => {
  ...
  const handleTouchEnd = (event) => {
    ...
    if (deltaX > 100) {
      ...
      // Add your logic to handle swipe to the right (e.g., go to the previous page)
    } else if (deltaX < -100) {
      setIsSwipeLeft(true);
      setIsSwipeRight(false);
      // Add your logic to handle swipe to the left (e.g., go to the next page)
    }
  };
  ...
  }, [touchStartX, touchEndX, setIsSwipeLeft, setIsSwipeRight]);
  ...
  return (
    ...
    <div  className={`chat ${isSwipeLeft ? styles['slide-out-left'] : ''} ${
      isSwipeRight ? styles['slide-out-right'] : ''
    }`}
