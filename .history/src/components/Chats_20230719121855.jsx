...
const Chats = ({ onSelectUser, selectedUser, selectedChatId, id }) => {
  ...
  const handleContextMenu = (e, chatId) => {
    e.preventDefault();
    setSelectedChat(chatId); // Store the selected chat ID
  ...
  return (
    <>
        ...
        return (
          <div key={chat[0]}>
             <div
              onContextMenu={(e) => handleContextMenu(e, chatId)} // Pass the chat ID to the context menu handler
            ...
            >
               <NavLink
                ...
                selectedChatId={chatId} // Pass the selectedChatId prop
              >
            ...
            {isMenuOpen && menuPosition && (
              ...
              >
                ...
                <button onClick={() => handleChatDelete(chat[0])}>
                  Delete
                </button>
              </div>
            )}
