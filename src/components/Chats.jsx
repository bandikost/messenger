...
const Chats = ({ onSelectUser, selectedUser, selectedChatId, id }) => {
  ...
  const handleContextMenu = (e, chatId) => {
    ...
    // Use the clientX and clientY values from the touch event on mobile devices
    const touchX = e.touches ? e.touches[0].clientX : e.clientX;
    const touchY = e.touches ? e.touches[0].clientY : e.clientY;
  
    setSelectedChat(chatId);
    setMenuPosition({ top: touchY, left: touchX });
  ...
  onClick={() => {
    ...
    handleClick(); // Add this line to close the context menu when a chat is clicked
  }}
>
            ...
            {isContextMenuVisible && menuPosition && selectedChat === chatId && ( // Show the delete button only for the selected chat
  <div
